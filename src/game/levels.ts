...
export const LEVELS: readonly LevelSource[] = [
  ...
  {
    name: "Scatter",
    briefing: "Five pillars, five crates, and nine opening moves — all but one of them wrong.",
    rows: [
      "#########",
      "#.$ $. .#",
      "# #   #$#",
  ...
  {
    name: "Partition",
    briefing: "A wall down the middle with gaps in it. The drops are all on your side.",
    rows: [
      "#########",
      "#   #   #",
      "# .$ $  #",
  ...
  {
    name: "Jigsaw",
    briefing: "Interlocking blocks and four crates. Nothing here moves in a straight line.",
    rows: [
      "##########",
      "#  ##  @ #",
      "# $.##.$ #",
  ...
  {
    name: "The Island",
    briefing: "A block marooned in the middle of the floor, and five crates to work around it.",
    rows: [
      "#########",
      "# .$ .  #",
      "#.###$  #",
  ...
  {
    name: "Pinch Point",
    briefing: "Six crates, and the room narrows exactly where you need the space.",
    rows: [
      "##########",
      "# . ##   #",
      "# $$... $#",
  ...
  {
    name: "Turnstile",
    briefing: "Four crates in a room of stubs. Twenty-one pushes; on their own they'd need four.",
    rows: [
      "##########",
      "#  .# #@##",
      "#  $$.$  #",
  ...
  {
    name: "The Lockup",
    briefing: "Four crates, four slots, and barely a square to spare.",
    rows: [
      "##########",
      "#.#  # #.#",
      "#  .$$.$@#",
  ...
  {
    name: "The Trench",
    briefing: "A cut across the room with three ways through, and six crates that all need one.",
    rows: [
      "##########",
      "#. $.    #",
      "#     $ .#",
  ...
  {
    name: "Stack Room",
    briefing: "Last mission. Six crates in the tightest room in the building. Good luck.",
    rows: [
      "##########",
      "# #  #.$ #",
      "# #  #   #",
